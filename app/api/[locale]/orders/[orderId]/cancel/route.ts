...
import { cancelOrder } from '@/lib/orders/server/order.service';
...
export async function PATCH(
  ...
  try {
    ...
    const result = await cancelOrder(validatedId.orderId, payload.email, locale);
    ...
    console.error('[PATCH /api/orders/[orderId]/cancel]', error);
